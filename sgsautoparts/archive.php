            ...
            <div class="col-md-8 col-12 mb-3">
                ...
                <div id="productContainer" class="row">
                    <?php
                        ...
                        // Check if the queried object is an author archive
                        if ($queried_object instanceof WP_User) {
                            $clicked_user_id = $queried_object->ID;
                        } else {
                            $clicked_user_id = 0; // Default value or handle accordingly
                        }
                        ...
                        if (!empty($clicked_user_id)) {
                            $args['author'] = $clicked_user_id;
                        }
                        ...
                        while ($blog_posts->have_posts()) {
                            ...
                            // Assuming 'display' is a folder and 'blog-card' is a template file inside it
